...
from app.utils.exceptions import (
    ...
    RateLimitError, DatabaseError, ConfigurationError, UserNotFoundError,
    InvalidCredentialsError, TokenExpiredError, DuplicateResourceError
)
from app.utils.error_handlers import (
    register_error_handlers, setup_error_monitoring, get_error_context,
    create_error_response, log_error_metrics
)
from app.utils.error_helpers import (
    validate_required_fields, validate_field_length, check_resource_exists,
    check_user_exists, validate_business_rule, safe_get_or_404
)
    ...
    def test_create_error_response_api_exception(self):
        ...
        with app.app_context():
            with app.test_request_context('/test'):
                error = ValidationError("Test validation error", field_errors={'field': 'error'})
...
class TestServiceIntegration:
    ...
    def test_auth_service_registration_validation(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            AuthService.register("ab", "test@example.com", "123")  # Short username and password
