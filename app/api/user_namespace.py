...
from app.api.models import (
    create_user_request_model,
    error_model,
    set_admin_status_model,
    success_model,
    update_user_request_model,
    user_list_response_model,
    user_model,
    user_response_model,
    user_statistics_response_model,
...
class UserListResource(Resource):
    ...
    @user_ns.param(
        "include_inactive", "Include inactive users", type="boolean", default=False
    )
    ...
    @user_ns.param(
        "sort_order", "Sort order", type="string", enum=["asc", "desc"], default="desc"
    )
    @user_ns.marshal_with(
        user_list_response_model, code=200, description="Users retrieved successfully"
    )
    ...
    @user_ns.marshal_with(
        user_response_model, code=201, description="User created successfully"
    )
...
class UserResource(Resource):
    ...
    @user_ns.marshal_with(
        user_response_model, code=200, description="User retrieved successfully"
    )
    @user_ns.response(401, "Invalid or expired access token", error_model)
    @user_ns.response(403, "Insufficient permissions", error_model)
    ...
    @user_ns.marshal_with(
        user_response_model, code=200, description="User updated successfully"
    )
    @user_ns.response(400, "Invalid request data", validation_error_model)
    @user_ns.response(401, "Invalid or expired access token", error_model)
    @user_ns.response(403, "Insufficient permissions", error_model)
    ...
    @user_ns.param(
        "hard_delete", "Whether to permanently delete", type="boolean", default=False
    )
    @user_ns.marshal_with(
        success_model, code=200, description="User deleted successfully"
    )
...
class UserActivateResource(Resource):
    ...
    @user_ns.marshal_with(
        user_response_model, code=200, description="User activated successfully"
    )
    @user_ns.response(401, "Invalid or expired access token", error_model)
    @user_ns.response(403, "Insufficient permissions", error_model)
    @user_ns.response(404, "User not found", error_model)
...
class UserDeactivateResource(Resource):
    ...
    @user_ns.marshal_with(
        user_response_model, code=200, description="User deactivated successfully"
    )
...
class UserUnlockResource(Resource):
    ...
    @user_ns.marshal_with(
        user_response_model, code=200, description="User unlocked successfully"
    )
    @user_ns.response(401, "Invalid or expired access token", error_model)
    @user_ns.response(403, "Insufficient permissions", error_model)
    @user_ns.response(404, "User not found", error_model)
...
class UserAdminStatusResource(Resource):
    ...
    @user_ns.marshal_with(
        user_response_model, code=200, description="Admin status updated successfully"
    )
    @user_ns.response(
        400, "Invalid request data or cannot demote self", validation_error_model
    )
    @user_ns.response(401, "Invalid or expired access token", error_model)
    @user_ns.response(403, "Insufficient permissions", error_model)
    @user_ns.response(404, "User not found", error_model)
...
class UserSearchResource(Resource):
    ...
    @user_ns.marshal_with(
        user_list_response_model, code=200, description="Search completed successfully"
    )
    @user_ns.response(400, "Invalid query parameters", validation_error_model)
    @user_ns.response(401, "Invalid or expired access token", error_model)
    @user_ns.response(403, "Insufficient permissions", error_model)
