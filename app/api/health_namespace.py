...
from app.api.models import (
    health_status_model, detailed_health_status_model, 
    readiness_status_model, liveness_status_model
)
...
class HealthCheckResource(Resource):
    ...
    @health_ns.marshal_with(health_status_model, code=200, description='Application is healthy')
...
class DetailedHealthCheckResource(Resource):
    ...
    @health_ns.marshal_with(detailed_health_status_model, code=200, description='Application is healthy')
...
class DatabaseHealthCheckResource(Resource):
    ...
    @health_ns.marshal_with(health_status_model, code=200, description='Database is healthy')
...
class SystemHealthCheckResource(Resource):
    ...
    @health_ns.marshal_with(detailed_health_status_model, code=200, description='System resources are healthy')
    @health_ns.response(503, 'System resources are unhealthy', detailed_health_status_model)
    def get(self):
        """
...
class ReadinessCheckResource(Resource):
    ...
    @health_ns.marshal_with(readiness_status_model, code=200, description='Application is ready')
...
class LivenessCheckResource(Resource):
    ...
    @health_ns.marshal_with(liveness_status_model, code=200, description='Application is alive')
