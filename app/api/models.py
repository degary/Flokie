...
user_model = api.model(
    "User",
    {
        ...
        "is_active": fields.Boolean(
            required=True, description="Whether user is active"
        ),
        "is_verified": fields.Boolean(
            required=True, description="Whether email is verified"
        ),
...
login_request_model = api.model(
    "LoginRequest",
    {
        ...
        "remember_me": fields.Boolean(
            description="Whether to create longer-lived tokens", default=False
        ),
    },
)
...
register_request_model = api.model(
    "RegisterRequest",
    {
        ...
        "password": fields.String(
            required=True, description="Password (minimum 8 characters)"
        ),
...
token_model = api.model(
    "Token",
    {
        ...
        "token_type": fields.String(
            required=True, description="Token type", default="Bearer"
        ),
    ...
    "LoginResponse",
    {
        ...
        "data": fields.Nested(
            api.model(
                ...
                {
                    "user": fields.Nested(
                        user_model, required=True, description="User information"
                    ),
                    "tokens": fields.Nested(
                        token_model, required=True, description="Authentication tokens"
                    ),
                },
            ),
            required=True,
...
register_response_model = api.model(
    "RegisterResponse",
    {
        "success": fields.Boolean(
            required=True, description="Registration success status"
        ),
        "message": fields.String(
            required=True, description="Registration result message"
        ),
        "data": fields.Nested(
            api.model(
                "RegisterData",
...
refresh_token_response_model = api.model(
    "RefreshTokenResponse",
    {
        "success": fields.Boolean(
            required=True, description="Token refresh success status"
        ),
        "message": fields.String(
            required=True, description="Token refresh result message"
        ),
        "data": fields.Nested(
            api.model(
                "RefreshTokenData",
                {
                    "access_token": fields.String(
                        required=True, description="New JWT access token"
                    ),
                    "token_type": fields.String(
                        required=True, description="Token type"
                    ),
                    "expires_in": fields.Integer(
                        required=True, description="Token expiration time in seconds"
                    ),
...
password_reset_request_model = api.model(
    "PasswordResetRequest",
    {
        "email": fields.String(
            required=True, description="Email address for password reset"
        )
    },
)
...
password_reset_model = api.model(
    "PasswordReset",
    {
        ...
        "new_password": fields.String(
            required=True, description="New password (minimum 8 characters)"
        ),
    },
)
...
email_verification_model = api.model(
    "EmailVerification",
    {"token": fields.String(required=True, description="Email verification token")},
)

# User management models
create_user_request_model = api.model(
    "CreateUserRequest",
    {
        "username": fields.String(
            required=True, description="Username (3-80 characters)"
        ),
        "email": fields.String(required=True, description="Email address"),
        "password": fields.String(
            description="Password (minimum 8 characters, optional)"
        ),
        "first_name": fields.String(description="First name (max 50 characters)"),
        "last_name": fields.String(description="Last name (max 50 characters)"),
        "is_admin": fields.Boolean(
            description="Whether user should be admin", default=False
        ),
        "is_verified": fields.Boolean(
            description="Whether email should be pre-verified", default=False
        ),
    },
)

update_user_request_model = api.model(
    "UpdateUserRequest",
    {
        ...
        "is_verified": fields.Boolean(
            description="Whether email is verified (admin only)"
        ),
                ...
                "UserListData",
                {
                    ...
                    "pagination": fields.Nested(
                        api.model(
                            ...
                            {
                                "page": fields.Integer(
                                    required=True, description="Current page number"
                                ),
                                "per_page": fields.Integer(
                                    required=True, description="Items per page"
                                ),
                                "total": fields.Integer(
                                    required=True, description="Total number of items"
                                ),
...
set_admin_status_model = api.model(
    "SetAdminStatus",
    {
        "is_admin": fields.Boolean(
            required=True, description="Whether user should be admin"
        )
    },
)
...
user_statistics_model = api.model(
    "UserStatistics",
    {
        "total_users": fields.Integer(
            required=True, description="Total number of users"
        ),
        "active_users": fields.Integer(
            required=True, description="Number of active users"
        ),
        "inactive_users": fields.Integer(
            required=True, description="Number of inactive users"
        ),
        "verified_users": fields.Integer(
            required=True, description="Number of verified users"
        ),
        "unverified_users": fields.Integer(
            required=True, description="Number of unverified users"
        ),
        "admin_users": fields.Integer(
            required=True, description="Number of admin users"
        ),
        "locked_users": fields.Integer(
            required=True, description="Number of locked users"
        ),
        "users_created_today": fields.Integer(
            required=True, description="Users created today"
        ),
        "users_created_this_week": fields.Integer(
            required=True, description="Users created this week"
        ),
        "users_created_this_month": fields.Integer(
            required=True, description="Users created this month"
        ),
    },
)

user_statistics_response_model = api.model(
    ...
    "HealthStatus",
    {
        ...
        "database": fields.Nested(
            api.model(
                ...
                {
                    "status": fields.String(
                        required=True, description="Database status"
                    ),
                ...
                api.model(
                    "HealthError",
                    {
                        "component": fields.String(
                            required=True, description="Component name"
                        ),
                        "message": fields.String(
                            required=True, description="Error message"
                        ),
                    },
                )
            ),
...
detailed_health_status_model = api.model(
    "DetailedHealthStatus",
    {
                        ...
                        api.model(
                            "ConnectionPool",
                            {
                                ...
                                "checked_in": fields.Integer(
                                    description="Checked in connections"
                                ),
                                "checked_out": fields.Integer(
                                    description="Checked out connections"
                                ),
                                "overflow": fields.Integer(
        ...
        "checks": fields.Nested(
            api.model(
                "HealthChecks",
                {
                    "database_connectivity": fields.Boolean(
                        description="Database connectivity check"
                    ),
                    "system_resources_available": fields.Boolean(
                        description="System resources availability check"
                    ),
                    "application_info_available": fields.Boolean(
                        description="Application info availability check"
                    ),
                },
            ),
...
readiness_status_model = api.model(
    "ReadinessStatus",
    {
            ...
            api.model(
                "ReadinessChecks",
                {
                    "database": fields.Boolean(
                        required=True, description="Database connectivity check"
                    )
                },
            ),
            required=True,
...
liveness_status_model = api.model(
    "LivenessStatus",
    {
