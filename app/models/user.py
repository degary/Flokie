...
class User(BaseModel, ValidationMixin):
    ...
    def check_password(self, password: str) -> bool:
        ...
        if is_valid:
            ...
            if current_attempts + 1 >= 5:
                ...
                logger.warning(f"Failed login attempt for user {self.username} (attempt {current_attempts + 1})")
    ...
    def to_dict(self, include_relationships: bool = False, exclude_fields: Optional[list] = None) -> Dict[str, Any]:
        """
        ...
        user_dict = super().to_dict(include_relationships=include_relationships, exclude_fields=default_exclude)
    ...
    @classmethod
    def get_active_users(cls, limit: Optional[int] = None, offset: Optional[int] = None):
        """
    ...
    @classmethod
    def get_verified_users(cls, limit: Optional[int] = None, offset: Optional[int] = None):
        """
