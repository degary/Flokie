...
class SortingSchema(Schema):
    ...
    sort_by = fields.Str(
        validate=validate.OneOf(
            ['created_at', 'updated_at', 'username', 'email', 'first_name', 'last_name'],
...
class SuccessResponseSchema(Schema):
    ...
    timestamp = fields.DateTime(missing=datetime.utcnow, description="Response timestamp")
...
def validate_username_format(username):
    ...
    reserved_usernames = [
        ...
        'support', 'help', 'info', 'contact', 'service', 'user', 'guest', 'anonymous',
...
def validate_name_format(name):
    ...
    if '  ' in name or name.startswith(' ') or name.endswith(' '):
        raise ValidationError("Name cannot have leading/trailing spaces or multiple consecutive spaces")
