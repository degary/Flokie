...
def register_blueprints(app):
    ...
    from app.controllers.doc_controller import doc_bp, swagger_bp
    ...
    logger.info("Documentation blueprint registered")

    # Register swagger JSON blueprint
    app.register_blueprint(swagger_bp)
    logger.info("Swagger JSON blueprint registered")
